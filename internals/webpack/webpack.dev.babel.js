...
const plugins = [
	...
	new CopyWebpackPlugin([
		{
			from: 'app/config/serverConfig.dev.js',
			to: 'serverConfig.js'
		}
	]),
...
function dependencyHandlers () {
   ...
   */
	if (!dllPlugin.dlls) {
		const manifestPath = path.resolve(dllPath, 'atomixFramework.json')
...
function templateContent () {
	...
	const dllNames = !dllPlugin.dlls ? ['atomixFramework'] : Object.keys(dllPlugin.dlls)
