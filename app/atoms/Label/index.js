...
import {
	...
	DEFAULT_COMPONENT_CAPITALIZATION
...
type PropTypes = {
	...
	capitalization?: ComponentCapitalization
}
// --------------------------------------------------------
...
function Label (props: PropTypes) {
	 ...
	 * @param       {Object} props Label component properties
		...
		if (_.isString(props.children)) {
			if (props.animationType && props.animationName) {
				return (
					...
					>
						{ _getLabelComponent(props) }
					</Animator>
				)
			} else {
				return _getLabelComponent(props)
			}
		} else {
			// @TODO Hot into the console system
			return null
		}
	}
	...
	/**
	 * Define component capitalization
	 * @param       {ComponentCapitalization | null} capitalization component property
	 * @return      {string} String containing text-transform class or default class
	 */
	function _getComponentCapitalization (capitalization: ComponentCapitalization | null): ComponentCapitalization {
		if (capitalization) {
			return capitalization
		} else {
			return DEFAULT_COMPONENT_CAPITALIZATION
		}
	}
